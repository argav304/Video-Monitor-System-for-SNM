...
<div class="wrapper col5">
  <div id="container">
    ...
    <div id="column">
            ...
            <form name="state" action="LikeDislike.jsp" method="post">
                
          <input type="submit" name="state" value="LIKE" style="width:100px; height:35px; background-color:#7CFC00; color:#003399;"/>
          <input type="submit"  name="state" value="DISLIKE" style="width:100px; height:35px; background-color:#DC143C; color:#003399;"/>
      </form>
